...
/*
   ...
   To add a new band, insert a new line in the table below, and add a
   corresponding entry in the bandCAL[] and bandMODE[] arrays.
   You can remove a band by deleting a line from each of these arrays
   if you do not want a given band. 
...
*/
Band band[] = {
    {"VHF", FM_BAND_TYPE, 8790, 10790, 10390, 1, 0}, /* 2025-05-18  msipin  Modified for USA FM radio bandplan
    */
...
void setup()
{
  ...
  ledcAttach(PIN_LCD_BL, 16000, 8);     // New version (3.x) of Expressif APIt
...
uint8_t getStrength() {
  if (currentMode != FM) {
    ...
    // Swapped order of these last two to correct the logic - 2025-05-18  msipin
